...
export const Topics: string[] = [
  ...
  "Dream House: อธิบายลักษณะบ้านในฝันของคุณ เช่น สถานที่ ขนาด หรือการตกแต่ง",
  "Volunteer Work and Charity: แชร์ประสบการณ์การทำงานอาสาสมัครหรือการมีส่วนร่วมในกิจกรรมเพื่อสังคม",
  "Favorite Childhood Games: เล่าถึงเกมหรือกิจกรรมที่คุณชอบทำในวัยเด็ก",
  "Public Transportation vs. Driving: หัวข้อเกี่ยวกับการเดินทางในชีวิตประจำวัน ความสะดวกสบายและประสบการณ์",
  "Dream Invention: อธิบายสิ่งประดิษฐ์ในฝันที่คุณอยากสร้างหรืออยากเห็น",
  "Inspirational People: พูดถึงบุคคลที่เป็นแรงบันดาลใจให้คุณ ไม่ว่าจะเป็นคนดังหรือคนในชีวิตของคุณ",
  "Local Landmarks: พูดถึงสถานที่สำคัญหรือแหล่งท่องเที่ยวในพื้นที่ที่คุณอาศัยอยู่",
];
